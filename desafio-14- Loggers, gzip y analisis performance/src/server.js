...
app.get('/', routeInfo, isAuth, routes.getInitial);

//*==================================[RUTAS AUTHENTICATE]======================================*//

app.post('/login', routeInfo, passport.authenticate('login', {failureRedirect:'/login_error', successRedirect:'/datos'}));

app.post('/register', routeInfo, passport.authenticate('register', {failureRedirect:'/register_error', successRedirect:'/'}));

//*==================================[RUTAS LOGIN]======================================*//

app.get('/login', routeInfo, routes.getLogin);

app.get('/login_error', routeInfo, routes.getLoginError);

//*==================================[RUTAS REGISTER]======================================*//

app.get('/register', routeInfo, routes.getRegister);

app.get('/register_error', routeInfo, routes.getRegisterError);

//*==================================[RUTAS DATOS]======================================*//

app.get('/datos', routeInfo, isAuth, routes.getProducts);


app.get('/info', routeInfo, routes.getInfo);

// ruta info con compresion gzip
app.get('/infogzip', compression(), routes.getInfo);


app.get('/api/randoms?:cant', routeInfo, routes.getRandom);

//*==================================[RUTA LOGOUT]======================================*//

app.get('/logout', routeInfo, routes.getLogout);

//*==================================[RUTA * ]======================================*//

app.all('*', routeError, routes.noMatch)
