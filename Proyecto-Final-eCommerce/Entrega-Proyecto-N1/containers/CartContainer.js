...
class CartContainer{
    ...
    deleteCartById(id){
        ...
        try{
            fs.writeFileSync(this.file, JSON.stringify(newCartsList, null, 3))
            return `carrito eliminado id: ${id}`
        }catch(err){
    ...
    deleteProdById(idCart, idProd){
        ...
        try{
            ...
            return `producto eliminado id: ${idProd} en carrito id: ${idCart}` 
        }catch(err){
